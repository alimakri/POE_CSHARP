...
(function () {
    ...
    var LivePage = Object.inherit({
        ...
        handleQuestionsMessage: function (message) {
            ...
            //for (var question in message.questions) {
            //    this.displayQuestion(message.questions[question]);
            //}
        },
    ...
    // TODO: Create a web socket connection to ws://localhost:59912/live/socket.ashx
    var socket = new WebSocket("ws://localhost:59912/live/socket.ashx");
    LivePage.create(
        socket,
